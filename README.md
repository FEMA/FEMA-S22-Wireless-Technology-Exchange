# FEMA OCTO Virtual Wireless Technology Exchange - Spring 2022

Welcome to FEMA's Office of the Chief Technology Officer repository for the Spring 2022 Virtual Technology Exchange focusing on wireless technologies!

## Participant Feedback & Contributions

For the participants in the FEMA-S22 Technology Exchange that have files, white papers, suggestions, solution samples, demos, code, or other technological responses you wish to be considered, create a repository under your own GitHub account and **tag it with the "fema-s22" or "fema-s22-wireless" topic**. See the GitHub document [Classifying Your Repository with Topics](https://docs.github.com/en/github/administering-a-repository/managing-repository-settings/classifying-your-repository-with-topics). This will facilitate monitoring of the social conversation around the “fema-f22” GitHub topic tag following the event.
